@extends('layouts/app', ['activePage' => 'dashboard', 'activeButton' => 'laravel', 'title' => 'Light Bootstrap Dashboard PRO Laravel by Creative Tim & UPDIVISION', 'navName' => 'Dashboard'])
                    ...
                    <div class="card card-stats">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="numbers">
                                        <p class="card-category">{{ __('Number') }}</p>
                    ...
                    <div class="card card-stats">
                        <div class="card-body ">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <div class="numbers">
                                        <p class="card-category">{{ __('Revenue') }}</p>
                ...
                <div class="col-md-12">
                    <div class="card ">
                        <div class="card-header ">
                            <h4 class="card-title">{{ __('Global Sales by Top Locations') }}</h4>
                            <p class="card-category">{{ __('All products that were shipped') }}</p>
                        </div>
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-md-6">
