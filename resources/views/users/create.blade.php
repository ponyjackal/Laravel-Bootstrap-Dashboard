@extends('layouts.app', ['activePage' => 'users', 'activeButton' => 'laravel', 'title' => 'Light Bootstrap Dashboard PRO Laravel by Creative Tim & UPDIVISION', 'navName' => 'Create Users'])
                            ...
                            <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-warning mt-4">{{ __('Create User') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
