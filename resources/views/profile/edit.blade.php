@extends('layouts.app', ['activePage' => 'profile', 'activeButton' => 'laravel', 'title' => 'Light Bootstrap Dashboard PRO Laravel by Creative Tim & UPDIVISION', 'navName' => 'Edit Profile'])

@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="section-image" data-image="{{ auth()->user()->profilePicture() }}">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('profile.update') }}" autocomplete="off"
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-warning mt-4">{{ __('Save') }}</button>
                                    </div>
                                </div>
                            </form>
                            <hr class="my-4" />
                            <form method="post" action="{{ route('profile.password') }}" autocomplete="off">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="text-center">
                                        <button type="submit" class="btn btn-warning mt-4">{{ __('Change password') }}</button>
                                    </div>
                                </div>
                            </form>
                        </div>
